...
bool UObject::IsValid() const {
	return this
		&& reinterpret_cast<uintptr_t>(this) <= 0x00007FFFFFFFFFFF
		&& VfTableObject.Dummy
		&& !(ObjectFlags & static_cast<uint64_t>(EObjectFlags::RF_Unreachable))
		&& Class
		&& ObjectInternalInteger >= 0
		&& ObjectInternalInteger < GObjObjects()->size()
		&& GObjObjects()->at(ObjectInternalInteger) == this;
};
